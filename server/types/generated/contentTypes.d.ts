...
export interface ApiHistoryHistory extends Schema.CollectionType {
  ...
  attributes: {
    OrderTime: Attribute.DateTime;
    history_owner: Attribute.Relation<
      'api::history.history',
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    ...
    products: Attribute.Relation<
      ...
      'api::product.product'
    >;
    history_items: Attribute.Relation<
      'api::history.history',
      'oneToMany',
...
export interface ApiHistoryItemHistoryItem extends Schema.CollectionType {
...
export interface ApiPicPic extends Schema.CollectionType {
  collectionName: 'pics';
  info: {
    singularName: 'pic';
    pluralName: 'pics';
  ...
  attributes: {
    ...
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<'api::pic.pic', 'oneToOne', 'admin::user'> &
      Attribute.Private;
    updatedBy: Attribute.Relation<'api::pic.pic', 'oneToOne', 'admin::user'> &
      Attribute.Private;
  };
}
